...
General-purpose registers, operand sizes, mov, lea, and xchg.
...
Run it with make run MODULE=01-registers and verify with make test-module MODULE=01-registers. Check solution.asm only after attempting it.
